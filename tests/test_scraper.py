...
@pytest.mark.asyncio
async def test_scraper_search_by_name():
...
@pytest.mark.asyncio
async def test_scraper_filter_by_platform():
...
@pytest.mark.asyncio
async def test_scraper_price_filters():
...
@pytest.mark.asyncio
async def test_scraper_rating_filters():
...
@pytest.mark.asyncio
async def test_scraper_stock_filters():
